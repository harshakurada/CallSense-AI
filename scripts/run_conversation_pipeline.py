"""Runs conversation-level prediction (category, resolution, satisfaction,
escalation) on a speaker-attributed conversation (Module 3's output).
...
def main():
    ...
    if args.output:
        ...
        logger.info("Wrote prediction to %s", args.output)
    else:
        print(output_json)
